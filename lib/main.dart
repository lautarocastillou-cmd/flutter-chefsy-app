    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(
          seedColor: const Color(0xFFE11D48), // Rojo vibrante Chefsy
          brightness: Brightness.dark,
        ),
        scaffoldBackgroundColor: const Color(0xFF0B0F19), // Dark Premium
        useMaterial3: true,
      ),
...
class _PortalCadeteScreenState extends State<PortalCadeteScreen> {
  ...
  void _escucharServicio() {
    FlutterBackgroundService().on('updatePosition').listen((event) {
  ...
  Future<void> _toggleRastreo() async {
    ...
    if (_estaRastreando) {
      ...
      bool permisosOk = await _verificarPermisosGps();
      if (!permisosOk) {
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
  ...
  Future<void> _fetchPedidos() async {
    ...
    try {
      ...
      // Error silencioso en red o sin internet en calle
    } finally {
      ...
      appBar: AppBar(
        title: const Row(
          children: [
            ...
            SizedBox(width: 10),
            Text('Chefsy Cadete', style: TextStyle(fontWeight: FontWeight.w900, letterSpacing: 0.5)),
          ],
        ),
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      ...
                      colors: _estaRastreando
                          ? [const Color(0xFF10B981), const Color(0xFF047857)] // Esmeralda
                          : [const Color(0xFFE11D48), const Color(0xFF9F1239)], // Rojo Chefsy
                    ),
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        _estaRastreando ? 'RASTREO EN BOLSILLO ACTIVO' : 'INICIAR TURNO Y RASTREO',
                        textAlign: TextAlign.center,
                        style: const TextStyle(fontSize: 19, fontWeight: FontWeight.w900, letterSpacing: 1.2),
                      ),
                          ...
                          return Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    const Icon(Icons.location_on_rounded, size: 16, color: Color(0xFFF43F5E)),
                                ...
                                SizedBox(
                                  ...
                                  child: ElevatedButton.icon(
                                    ...
                                    onPressed: () => _abrirWhatsApp(p['telefono'] ?? '', p['cliente'] ?? ''),
                                  ),
                                ),
                              ],
                            ),
